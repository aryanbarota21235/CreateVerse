...
export default function PageHero({
  ...
  return (
    <section className={`relative overflow-hidden bg-paper pt-[58px] sm:pt-[76px] ${className}`}>
      ...
      <div className="container-site relative pb-5 sm:pb-8 pt-2.5 sm:pt-16 lg:pt-20">
        <Reveal>
