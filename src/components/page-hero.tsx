    ...
    <section className="relative overflow-hidden bg-paper pt-[76px]">
      ...
      <div className="container-site relative pb-20 pt-16 sm:pt-24 lg:pt-28">
        <Reveal>
          ...
          <h1 className="text-balance mt-4 max-w-3xl font-display text-5xl font-semibold tracking-tightest text-ink sm:text-6xl">
            {title}
          </h1>
          {description && <p className="mt-6 max-w-2xl text-lg leading-relaxed text-ink/60">{description}</p>}
        </Reveal>
      </div>
    </section>
  );
