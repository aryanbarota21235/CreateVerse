...
const leadershipPillars = [
  {
    title: "Constituency & Urban Growth",
    desc: "Advocating modern industrial zones, enhanced civic facilities, and robust road networks for the burgeoning Sonipat NCR corridor.",
  },
  {
    title: "Youth Mobilization & Skilling",
    desc: "Spearheading mentorship, technical education drives, and employment facilitation initiatives for the youth of Haryana.",
  },
  {
    title: "Public Welfare & Grievance Redressal",
    desc: "Maintaining direct, transparent channels for citizens to resolve public issues, government scheme enrolments, and local amenities.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "CreateVerse Political Campaign Division provides high-tech digital campaign architecture, booth-level voter mobilization, narrative management, and 24/7 war room intelligence for prominent political leaders.",
  },
  {
...
export default function UmeshSharmaPage() {
  const jsonLd = {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-paper text-ink selection:bg-accent selection:text-white">
          ...
          <div className="container-site relative pt-6 sm:pt-10 pb-10 sm:pb-16">
            ...
            <Reveal>
              <nav className="flex items-center gap-2 text-xs font-semibold text-stone-500 uppercase tracking-wider mb-6 sm:mb-8">
                ...
                <ChevronRight className="h-3.5 w-3.5 text-stone-400" />
                <span className="text-ink font-bold">Umesh Sharma</span>
              </nav>
            </Reveal>
              ...
              <div className="lg:col-span-8 order-2 lg:order-1">
                <Reveal>
                  ...
                  <div className="mt-6 flex items-center gap-2.5">
                    ...
                    <a
                      href="https://www.facebook.com/UmeshSharmaSnp"
                      target="_blank"
                      ...
                      aria-label="Umesh Sharma Facebook"
                    >
        ...
        {/* ==========================================================================
            SECTION: Public Service & Leadership
            ========================================================================== */}
        ...
        <section className="py-12 sm:py-16 bg-white border-b border-stone-200">
          <div className="container-site">
            <Reveal>
              <h2 className="font-display text-2xl sm:text-4xl font-bold tracking-tight text-ink">
                Connect With Umesh Sharma
              </h2>
              <p className="mt-2.5 text-sm sm:text-base text-stone-600">
                Follow updates on political programs, social events, and civic outreach in Sonipat.
              </p>
            </Reveal>
              ...
              <Reveal>
                ...
                >
                  ...
                  <div className="truncate">
                    ...
                    <span className="text-[11px] text-stone-500 truncate block">facebook.com/UmeshSharmaSnp</span>
                  </div>
                </a>
              </Reveal>
            </div>
          ...
          <div className="container-site text-center">
            <Reveal>
              ...
              <blockquote className="font-display text-xl sm:text-3xl font-bold text-white max-w-2xl mx-auto leading-snug">
                &ldquo;Devotion to the nation, service to society, and empowering every family in Haryana.&rdquo;
              </blockquote>
